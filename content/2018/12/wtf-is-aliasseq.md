...
コンパイル時にスライスを取ったりインデックスでアクセスしたりできます。
...
こっちは実際に使ったものです。
[自作Cコンパイラ](/2018/12/compiler-in-d/)には以下のようなコードがあります。
...
D言語の標準ライブラリにはこういう便利なものがいっぱいあるので、
